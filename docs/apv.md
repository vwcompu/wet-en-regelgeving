# Algemene Plaatselijke Verordening SKY Roleplay
...
| Officiële naam regeling   | Algemene Plaatselijke Verordening SKY Roleplay|
| Citeertitel               | Algemene Plaatselijke Verordening SKY Roleplay|
| Vastgesteld door          | De Hoge Raad|
| Onderwerp                 | Openbare orde en veiligheid|

### Opmerkingen met betrekking tot de verordening

Het Wetboek van Strafrecht, specifiek bedoeld voor SKY Roleplay, wordt hierbij ingetrokken en vervangen door deze APV.

## Algemene Bepalingen

### A1 - Reikwijdte

1. Deze Algemene Plaatselijke Verordening (verder aangeduid als APV) is bedoeld als aanvulling op het Nederlands Recht en heeft betrekking op het eiland, de gemeente, en de stad SKY Roleplay.
...
1. Aanvullend op de APV is er het Wetboek SKY Roleplay (WTDA), waarin alle wetten, artikelen en bepalingen zijn opgenomen die gelden in SKY Roleplay.
...
7. Wanneer je met meerdere mensen die op SKY Roleplay spelen in een voice call zit is streamen niet toegestaan en moet je gedeafened en gemute zijn.
...
3. Officiële kleding verstrekt vanuit SKY Roleplay bedoeld voor specifieke groeperingen mogen niet door andere gebruikt worden tenzij hier sterke roleplay aan verbonden is.
...
1. Onder "criminele organisaties" vallen alle officiële groepen gevestigd in SKY Roleplay.
...
6. Een voorwaarde voor het samenwerken tussen criminele organisaties is dat er geen volledige samenwerking tussen alle organisaties ontstaat en dat dit niet gebeurd tijdens het witwassen van geld. Dit is ter beoordeling van de Hoge Raad van SKY Roleplay.
7. Wanneer officiële organisaties een samenwerking aangaan met een andere officiële organisatie dan dient dit gemeld te worden volgens het [format](/apv/#bijlage-2) in het daarvoor aangemaakte kanaal in de SKY Roleplay Discord.
...
1. Wanneer de leden in een server supporSKY organisatie zodanig opvallen op een negatieve manier (bijvoorbeeld veel warnings), zal de Hoge Raad beslissen over een gepaste straf jegens deze organisatie. Bij criminele organisaties kan dit zelfs leiden tot een volledige opschorting van de groep.
...
---------------------
APV opgesteld uit naam van de Hoge Raad, bedoeld voor het eiland, de gemeente en de stad “SKY Roleplay”, opgetekend door Tom Kapoet, te SKY Roleplay.
